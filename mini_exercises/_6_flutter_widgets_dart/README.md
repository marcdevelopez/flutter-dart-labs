## 📘 README – Proyecto `_6_flutter_widgets_dart`
...
`_6_flutter_widgets_dart` es una **mini-app de galería interactiva** que demuestra el uso de distintos tipos de widgets básicos, de diseño e interactivos en Flutter.
...
```
FLUTTER-DART-LABS/mini_exercises/_6_flutter_widgets_dart
```
...
2. Navega hasta
   `mini_exercises/_6_flutter_widgets_dart`
...
1. Abre una terminal en la raíz del módulo:
   ...
   ```bash
   cd mini_exercises/_6_flutter_widgets_dart
   ```
